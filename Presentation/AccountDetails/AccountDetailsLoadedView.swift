...
struct AccountDetailsLoadedView: View {
    @ObservedObject var viewModel: AccountsDetailViewModel
    ...
    init(viewModel: AccountsDetailViewModel) {
...
#Preview {
    AccountDetailsLoadedView(viewModel: AccountsDetailViewModel(account: Account(id: 1, accountNumber: "1234567890", name: "John Doe", balance: 100.0, currency: "GBP")))
}
